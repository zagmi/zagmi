...
#### Custom credentials
If you want to integrate `zagmi` with other wallet providers, you can implement
...
listen for events emitted by smart contracts. See [this file](https://github.com/simolus3/zagmi/blob/development/example/contracts.dart)
for an example.

### Dart Code Generator

By using [Dart's build system](https://github.com/dart-lang/build/), zagmi can
